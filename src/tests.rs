...
mod tests {
    ...
    fn generate_lock(index, amhl, message) -> ()  {
        let (r_1, decommit, lock_party1_message1) =
            LockParty1Message1::first_message(&amhl.setup_chain[1].Y_i_minus_1);
    ...
    fn generate_2p_address() -> (curv::elliptic::curves::secp256_k1::Secp256k1Point, curv::elliptic::curves::secp256_k1::Secp256k1Point,
        ...
        return (pubkey_party_one, pubkey_party_two,
         secret_share_party_two, party_two_paillier, dk);
    }
    ...
    fn test_release() {
        ...
        // party0 in Lock protocol plays party_one . party1 in Lock protocol plays party_two
        let (pubkey_party_one, pubkey_party_two,
             secret_share_party_two, party_two_paillier, dk) = generate_2p_address();
        let (r_1, decommit, lock_party1_message1) =
            LockParty1Message1::first_message(&amhl.setup_chain[1].Y_i_minus_1);
